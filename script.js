...
var submitPin = document.getElementById("submitted");
var numberBtn = document.getElementById("numbersArea").value;
var generatedPin = document.getElementById("display").value;

submitPin.addEventListener("click", function () {

    if (numberBtn === generatedPin) {
